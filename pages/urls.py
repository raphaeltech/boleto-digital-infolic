...
from .views import buscarCliente, copiarFatura, imprimirFatura, listarFaturasSF, listarFaturasCPS, salvarFatura
...
urlpatterns = [
    ...
    path('slavarfatura/<int:codFatura>', salvarFatura, name="salvarfatura"),
